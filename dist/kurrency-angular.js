...
(function (w, d) {
  ...
  function setupKurrency() {
    ...
    w[KURRENCY_CONFIG.ANGULAR].module('KurrencyApp').constant('kurrencyConfig', {
      ...
      'kurrencyConfig',
      '$rootScope',
      function (kurrency, kurrencyConfig, $rootScope) {
        var $scope = this;
        $scope.menu = [];
        $scope.cart = [];
        $scope.sidebars = [];
      ...
      'kurrencyConfig',
      '$filter',
      function (kurrency, kurrencyConfig, $filter) {
        return {
          restrict: 'E',
          scope: { id: '=' },
          templateUrl: function (tElement, tAttrs) {
      ...
      '$document',
      '$rootScope',
      function (kurrency, kurrencyConfig, kurrencyMenuService, $timeout, $window, $document, $rootScope) {
        return {
          restrict: 'E',
          templateUrl: function (tElement, tAttrs) {
