        ...
        return {
          ...
          link: function (scope, element, attr) {
            ...
            scope.getTaxes = function () {
              kurrency.orders.taxes(scope.product_total, { ship_to: { address: { postal_code: scope.checkout.ship_to.address.postal_code } } }, function (err, tax) {
                scope.tax_total = tax;
                scope.updateFinalTotal();
              });
            };
            scope.getRates = function () {
              if (!scope.checkout.ship_to.address.postal_code || scope.checkout.ship_to.address.postal_code.length < 5) {
                return;
              }
